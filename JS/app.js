...
console.log(old);
let left = document.getElementById('arrow-left').addEventListener("click", function () {
    left.style.display = "block";
})
let right = document.getElementById('fa-arrow-right').addEventListener("click", function () {
